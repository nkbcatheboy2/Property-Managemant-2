...
if (!user_has_category_access('Lottery')) {
    die('Access denied: you do not have access to the Lottery module.');
}

$properties = $pdo->prepare("SELECT id, scheme_name, property_code, address, status, price FROM properties WHERE category = 'Lottery' ORDER BY created_at DESC");
$properties->execute();
    ...
    <div class="portal-content">
        ...
        <aside class="portal-sidebar portal-sidebar-right" id="moduleSidebar">
            ...
            <div class="portal-sidebar-section">
                ...
                <a href="module_lottery.php" class="portal-nav-item active">🎰 Lottery</a>
        ...
        <main class="portal-main">
            <div class="portal-page-header mb-4">
                <h1 class="portal-page-title">Lottery Process</h1>
                <p class="portal-page-subtitle">Manage lottery-related properties and allocation workflow.</p>
            </div>
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <?php if (empty($properties)): ?>
                                    <tr><td colspan="7" class="text-center text-muted">No lottery properties are available.</td></tr>
                                <?php endif; ?>
