...
if (!user_has_category_access('FCFS')) {
    die('Access denied: you do not have access to the FCFS module.');
}

$properties = $pdo->prepare("SELECT id, scheme_name, property_code, address, status, price FROM properties WHERE category = 'FCFS' ORDER BY created_at DESC");
$properties->execute();
    ...
    <div class="portal-content">
        ...
        <aside class="portal-sidebar portal-sidebar-right" id="moduleSidebar">
            ...
            <div class="portal-sidebar-section">
                ...
                <a href="module_fcfs.php" class="portal-nav-item active">📦 FCFS</a>
        ...
        <main class="portal-main">
            <div class="portal-page-header mb-4">
                <h1 class="portal-page-title">FCFS Process</h1>
                <p class="portal-page-subtitle">Manage first-come-first-served property allocation.</p>
            </div>
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <?php if (empty($properties)): ?>
                                    <tr><td colspan="7" class="text-center text-muted">No FCFS properties are available.</td></tr>
                                <?php endif; ?>
