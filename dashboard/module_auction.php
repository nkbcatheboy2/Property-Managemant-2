...
if (!user_has_category_access('Auction')) {
    die('Access denied: you do not have access to the Auction module.');
}

$properties = $pdo->prepare("SELECT id, scheme_name, property_code, address, status, price FROM properties WHERE category = 'Auction' ORDER BY created_at DESC");
$properties->execute();
    ...
    <div class="portal-content">
        ...
        <aside class="portal-sidebar portal-sidebar-right" id="moduleSidebar">
            ...
            <div class="portal-sidebar-section">
                ...
                <a href="module_auction.php" class="portal-nav-item active">🔨 Auction</a>
        ...
        <main class="portal-main">
            <div class="portal-page-header mb-4">
                <h1 class="portal-page-title">Auction Process</h1>
                <p class="portal-page-subtitle">Manage auction-related properties and bidding workflow.</p>
            </div>
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <?php if (empty($properties)): ?>
                                    <tr><td colspan="7" class="text-center text-muted">No auction properties are available.</td></tr>
                                <?php endif; ?>
